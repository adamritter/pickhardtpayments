...
print(num_nodes(lightning_edges), len(lightning_edges), rene, otto, tested_amount, file=f)
for lightning_edge in lightning_edges:
    print(lightning_edge[0], lightning_edge[1], lightning_edge[2], lightning_edge[3], file=f)
f.close()
print("written")
